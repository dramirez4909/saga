...
def create_medication():
    data = request.json
    print("!!!!!!!!!!!!!!!!!!!!!!!!!",data)
    medication = Medication(patient_id=data["patient"],instructions=data['instructions'],provider_id=data['provider_id'],name=data['medication'], created_at=datetime.now())
