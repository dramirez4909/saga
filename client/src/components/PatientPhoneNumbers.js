...
function PatientPhoneNumbers(props) { 
    ...
    return (
        <>
                <div style={{display:"flex",marginBottom:"4px",flexDirection:"column",borderRadius:"8px",width:"fit-content",padding:"4px",marginRight:"9px",boxShadow:"rgba(0, 0, 0, 0.12) 0px 1px 3px, rgba(0, 0, 0, 0.24) 0px 1px 2px",}}>
