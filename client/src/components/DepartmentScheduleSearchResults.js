...
const DepartmentScheduleSearchResults = (props) => {
        ...
        >
            ...
            <div className={classes.paper} style={{maxWidth:"600px",width:"100%",backgroundColor:props.themeContext.themes === "dark" ? "#444444" : "white",display:"flex",flexDirection:"column"}}>
                ...
                {props.departments.map(department=>{
                    ...
                    return(
                    <div onClick={(e)=>props.openDepartmentSchedule(department)} style={{background:"grey",display:"flex",flexDirection:"column",alignItems:"center",marginLeft:"14px",marginBottom:"5px",marginRight:"14px",borderRadius:"8px",width:"100%"}}>
...
export default DepartmentScheduleSearchResults