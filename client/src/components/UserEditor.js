...
const UserEditor = (props) => {
    ...
    return (
      <div className={classes.paper} style={{alignItems:"center",display:"flex",flexDirection:"column",outline:"none",width:"100%",color:themeContext.themes === "dark" ? "white" : "#444444",paddingTop:"20px",paddingBottom:"180px",backgroundColor:themeContext.themes === "dark" ? "#444444" : "white"}}>
