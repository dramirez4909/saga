...
const Navbar = (props) => {
  ...
  return (
    ...
    <PatientSearchContext.Provider value={{setDisplayPatientSearchResults,setPatientSearchTerm}}>
      ...
      <div style={{flexGrow:1,position:"fixed",display:"block",left:0,right:0,top:0,zIndex:999,minHeight:"44px",  boxShadow: "rgb(0 0 0 / 10%) 0px 1px 3px 0px, rgb(0 0 0 / 6%) 0px 1px 2px 0px"}}>
        <div style={{display:"flex", alignItems:"center",backgroundColor:"rgba(255,255,255)",minHeight:"44px"}}>
