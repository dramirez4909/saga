        ...
        <div style={{
            ...
            <div style={{
                ...
                <TextField 
                    size="small" 
                    fullWidth 
                    value={regContext.weight} 
                    onChange={(e)=>regContext.setWeight(e.target.value)} 
                    style={{margin:"5px"}}
                    id="outlined-basic" 
                    label="Weight" 
                    variant="outlined" />
                <TextField 
                    size="small" 
                    fullWidth 
                    value={regContext.height} 
                    onChange={(e)=>regContext.setHeight(e.target.value)} 
                    style={{margin:"5px"}}
                    id="outlined-basic" 
                    label="Height" 
                    variant="outlined" 
            ...
            <div 
                ...
                <TextField 
                    size="small" 
                    fullWidth 
                    value={regContext.bmi} 
                    onChange={(e)=>regContext.setBmi(e.target.value)} 
                    style={{
                        margin:"5px"
                        }}
                    id="outlined-basic" 
                ...
                <TextField 
                    size="small" 
                    fullWidth 
                    value={regContext.heartRate} 
                    onChange={(e)=>regContext.setHeartRate(e.target.value)}
                    style={{margin:"5px"}}
                    id="outlined-basic" 
                    label="Heart Rate" 
                    variant="outlined" 
